...
begin
  ...
  glBegin(GL_QUADS);
    glNormal3f(0, -1, 0);
	  glTexCoord2d(0.666467, 0.666467);    glVertex3f(1, -1, -1);
	  glTexCoord2d(0.333533, 0.666467);    glVertex3f(1, -1, 1);
	  glTexCoord2d(0.333533, 0.333533);    glVertex3f(-1, -1, 1);
	  glTexCoord2d(0.666467, 0.333533);    glVertex3f(-1, -1, -1);
  glEnd;

  glColor3f (0.0, 1.0, 0.0); 
  glBegin(GL_QUADS);
    glNormal3f(0, 1, 0);
	  glTexCoord2d(0.333134, 0.333133);    glVertex3f(1, 1, -0.999999);
	  glTexCoord2d(0.000200, 0.333134);    glVertex3f(-1, 1, -1);
	  glTexCoord2d(0.000200, 0.000200);    glVertex3f(-1, 1, 1);
	  glTexCoord2d(0.333133, 0.000200);    glVertex3f(0.999999, 1, 1.000001);
  glEnd;

  glColor3f (0.0, 0.0, 1.0);
  glBegin(GL_QUADS);
    glNormal3f(1, 0, 0);
	  glTexCoord2d(0.999800, 0.333533);    glVertex3f(1, -1, -1);
	  glTexCoord2d(0.999800, 0.666467);    glVertex3f(1, 1, -0.999999);
	  glTexCoord2d(0.666866, 0.666467);    glVertex3f(0.999999, 1, 1.000001);
	  glTexCoord2d(0.666866, 0.333533);    glVertex3f(1, -1, 1);
  glEnd;

  glColor3f (1.0, 0.0, 1.0);
  glBegin(GL_QUADS);
    glNormal3f(-0, -0, 1);
	  glTexCoord2d(0.999800, 0.000200);    glVertex3f(1, -1, 1);
	  glTexCoord2d(0.999800, 0.333134);    glVertex3f(0.999999, 1, 1.000001);
	  glTexCoord2d(0.666866, 0.333134);    glVertex3f(-1, 1, 1);
	  glTexCoord2d(0.666866, 0.000200);    glVertex3f(-1, -1, 1);
  glEnd;

  glColor3f (1.0, 1.0, 0.0); 
  glBegin(GL_QUADS);
    glNormal3f(-1, -0, -0);
	  glTexCoord2d(0.333533, 0.333134);    glVertex3f(-1, -1, 1);
	  glTexCoord2d(0.333533, 0.000200);    glVertex3f(-1, 1, 1);
	  glTexCoord2d(0.666467, 0.000200);    glVertex3f(-1, 1, -1);
	  glTexCoord2d(0.666467, 0.333134);    glVertex3f(-1, -1, -1);
  glEnd;

  glColor3f (0.0, 1.0, 1.0);
  glBegin(GL_QUADS);
    glNormal3f(0, 0, -1);
	  glTexCoord2d(0.333134, 0.333533);    glVertex3f(1, 1, -0.999999);
	  glTexCoord2d(0.333134, 0.666467);    glVertex3f(1, -1, -1);
	  glTexCoord2d(0.000200, 0.666467);    glVertex3f(-1, -1, -1);
	  glTexCoord2d(0.000200, 0.333533);    glVertex3f(-1, 1, -1);
  glEnd;
