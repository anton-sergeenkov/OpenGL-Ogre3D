...
begin
  ...
  glColor3f (1.0, 1.0, 1.0); // цвет объекта
  glPointSize(5);
  glBegin(GL_POINTS);
    glVertex3f(1, -1, -1);
    glVertex3f(1, -1, 1);
  ...
  glColor3f (1.0, 0.0, 0.0); // цвет объекта
  glBegin(GL_QUADS);
    glNormal3f(0, -1, 0);
    glVertex3f(1, -1, -1);
    glVertex3f(1, -1, 1);
  ...
  glColor3f (0.0, 0.0, 1.0); // цвет объекта
  glBegin(GL_QUADS);
    glNormal3f(1, 0, 0);
    glVertex3f(1, -1, -1);
    glVertex3f(1, 1, -0.999999);
  ...
  glColor3f (1.0, 0.0, 1.0); // цвет объекта
  glBegin(GL_QUADS);
    glNormal3f(-0, -0, 1);
    glVertex3f(1, -1, 1);
    glVertex3f(0.999999, 1, 1.000001);
  ...
  glColor3f (1.0, 1.0, 0.0); // цвет объекта
  glBegin(GL_QUADS);
    glNormal3f(-1, -0, -0);
    glVertex3f(-1, -1, 1);
    glVertex3f(-1, 1, 1);
  ...
  glColor3f (0.0, 1.0, 1.0); // цвет объекта
  glBegin(GL_QUADS);
    glNormal3f(0, 0, -1);
    glVertex3f(1, 1, -0.999999);
    glVertex3f(1, -1, -1);
